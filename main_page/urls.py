...
urlpatterns = [
    ...
    re_path(r'^addrecord/$',          views.addrecord,          name="addrecord"),
    re_path(r'^sendrecord/$',         views.sendrecord,         name="sendrecord"),
    re_path(r'^readrecords/$',        views.readrecords,        name="readrecords"),
